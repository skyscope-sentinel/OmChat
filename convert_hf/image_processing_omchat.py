...
def divide_to_patches2(image: np.array, patch_size: int, input_data_format) -> List[np.array]:
    """
    Divides an image into patches of a specified size.
...
class OmChatImageProcessor(BaseImageProcessor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        image_grid_pinpoints = (
            ...
            else [[448, 896], [896, 448], [896, 896], [1344, 448], [448, 1344], [1344, 896], [896, 1344], [1344, 1344]]
        )
    ...
    def get_image_patches(
        ...
        patches = divide_to_patches(image_padded, 448)
        ...
        #    input_data_format=input_data_format,
        #)
        image_original_resize = image.resize((448,448))
